 ...
 * @author raunak
 */
public class FinalizeHousingWorkRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public FinalizeHousingWorkRequestJPanel(JPanel userProcessContainer, FinalizeHouseWorkRequest request, UserAccount userAccount, EcoSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        if(request.getHomelessPerson()!=null){
            ...
            row[3] = request.getHomelessPerson().getPreferredLocation();
            model1.addRow(row);   
        }
    ...
    private void initComponents() {
        ...
        submitJButton.setText("Select a house and scheme to finalize");
        ...
        jLabel2.setText("FINALIZE HOUSING");
        ...
        jLabel4.setText("Housing Options and Schemes available for this Person");
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        FinalizeHousingWorkAreaJPanel dwjp = (FinalizeHousingWorkAreaJPanel) component;
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        fcRequest.setAddressForHomeless(address);
            ...
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                if (enterprise instanceof LocalPublicAgencyEnterprise) {
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof HouseAgreementOrganization) {
                            org = organization;
                            break;
                        }
                    }
